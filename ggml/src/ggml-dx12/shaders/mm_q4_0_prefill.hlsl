...
groupshared half lds_weights[32][QK4_0];
...
void DequantBlockToLDS_Q4_0(uint n_in_tile, uint blockByteOffset, uint lane)
{
...
void main(uint3 GTid : SV_GroupThreadID, uint3 Gid : SV_GroupID)
{
    ...
    {
        uint block_byte_offset = (n_global * k_blocks + kb) * 18;
        DequantBlockToLDS_Q4_0(n_in_tile, block_byte_offset, GTid.x);
